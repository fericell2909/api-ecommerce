...
/**
 * @OA\Schema(
 *     schema="ResponseFile200DeleteSchema",
 *     type="object",
 *     description="Respuesta de eliminación de Archivo.",
 *     @OA\Property(property="status", type="boolean", example=true),
 *     @OA\Property(property="message", type="string", example="El archivo ha sido eliminado exitosamente."),
 ...
 * )
 */
class ResponseFile200DeleteSchema {
